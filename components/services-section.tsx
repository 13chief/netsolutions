...
const services = [
  {
    ...
    description: "Streamline client intake, document collection, and reporting processes to save hours every week.",
  },
  {
    icon: (
      <svg
    ...
    description: "Deploy intelligent chatbots that handle customer inquiries 24/7 with natural language understanding.",
  },
  {
    icon: (
      <svg
...
export function ServicesSection() {
  return (
    <section id="services" className="bg-muted/30 py-20 lg:py-32">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
            Comprehensive AI and automation solutions tailored to modern business challenges
          </p>
        </div>
